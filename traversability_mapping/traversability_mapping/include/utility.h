...
// Filter Ring Params
extern const int scanNumCurbFilter = 16;
extern const int scanNumSlopeFilter = 20;
extern const int scanNumMax = std::max(scanNumCurbFilter, scanNumSlopeFilter);
// extern const int scanNumCurbFilter = 16;
// extern const int scanNumSlopeFilter = 20;
// extern const int scanNumMax = 32;
...
extern const int localMapLength = 300; // length of the local occupancy grid map (meter)
extern const int localMapArrayLength = localMapLength / mapResolution;
...
extern const float visualizationRadius = 300;
extern const float visualizationFrequency = 2; // n, skip n scans then publish, n=0, visualize at each scan
...
extern const bool planningUnknown = true;
extern const float costmapInflationRadius = 0.5;
extern const float neighborSampleRadius  = 1.0;
extern const float neighborConnectHeight = 2.0;
extern const float neighborConnectRadius = 4.0;
extern const float neighborSearchRadius = localMapLength / 2;
