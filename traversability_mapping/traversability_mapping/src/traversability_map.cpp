...
private:
    ...
    ros::Publisher pubOccupancyMapLocalHeightSave;
    ...
    elevation_msgs::OccupancyElevation occupancyMap2DHeightSave;
...
public:
    TraversabilityMapping():
        ...
        subSaveMap = nh.subscribe<nav_msgs::OccupancyGrid>("/map", 5, &TraversabilityMapping::saveMapHandler, this);
        ...
        pubOccupancyMapLocalHeightSave = nh.advertise<elevation_msgs::OccupancyElevation> ("/occupancy_map_local_height_save", 5);
    ...
    void saveMapHandler(const nav_msgs::OccupancyGridConstPtr& msg){
        occupancyMap2DHeightSave.occupancy = *msg;
    }
    ...
    void publishLocalMap(){
        ...
        occupancyMap2DHeightSave.header = occupancyMap2DHeight.header;
        occupancyMap2DHeightSave.costMap = occupancyMap2DHeight.costMap;
        occupancyMap2DHeightSave.height = occupancyMap2DHeight.height;
        
        pubOccupancyMapLocalHeightSave.publish(occupancyMap2DHeightSave);
